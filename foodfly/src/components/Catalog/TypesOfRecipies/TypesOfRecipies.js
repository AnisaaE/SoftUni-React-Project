    ...
    return (
        <div className="container marketing">
            <div className="col-lg-4">
              ...
              <p><Link className="btn btn-secondary" to='/catalog/type/Main-Meals'>View recipes &raquo;</Link></p>
            </div>
            <div className="col-lg-4">
            <img src="https://www.allrecipes.com/thmb/BY8CcWT0JZOjFcWeIem9Fik1x78=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/9266919-c023924050f9406bab6eccea1664e88b.jpg"/>
              ...
              <p><Link className="btn btn-secondary" to="/catalog/type/Cakes">View recipes &raquo;</Link></p>
            </div>
            <div className="col-lg-4">
              ...
              <p><Link className="btn btn-secondary" to="/catalog/type/Breakfast">View recipes &raquo;</Link></p>
            </div>
            ...
            <div className="col-lg-4">
              ...
              <p><Link className="btn btn-secondary" to="/catalog/type/Healthy">View recipes &raquo;</Link></p>
            </div>
            <div className="col-lg-4">
                <img src="https://www.air-dr.com/wp-content/uploads/2021/08/p03bhpv0.jpg"/>
                <h2 className="fw-normal">Others</h2>
              <p><Link className="btn btn-secondary" to="/catalog/type/Others">View Recipes &raquo;</Link></p>
            </div>
    </div>
    );
  }